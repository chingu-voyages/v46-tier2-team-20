...
function Footer() {
  return (
    <div className="footer sticky top-0 left-0">
      ...
      <div className="footer-container">
        ...
        <div className="flex items-center">
          ...
          <div className="pr-2">
            <a href="https://github.com/chingu-voyages/v46-tier2-team-20" target="_blank" rel="noreferrer"><img src="/github-mark-white.png" alt="github-logo" width="30" height="30" /></a>
          </div>
