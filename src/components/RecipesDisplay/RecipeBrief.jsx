...
export default function RecipesBrief({ recipes }) {
  const data = recipes && recipes.map((recipe) => {
    ...
    return (
      <div key={nanoid()} className="recipe-card bg-no-repeat bg-cover bg-center rounded-lg flex flex-col items-start justify-end" style={{ backgroundImage: `url(${thumbnailUrl})` }}>
